...
import { Contract, nativeToScVal, xdr, TransactionBuilder, SorobanRpc, Keypair, BASE_FEE } from '@stellar/stellar-sdk';
import { z } from 'zod';
import { addressToScVal, i128ToScVal, boolToScVal, u32ToScVal } from './helper.js';
// Configuration
const config = {
...
mcpServer.tool("authorized", "Returns true if \`id\` is authorized to use its balance.\n\n# Arguments\n\n* \`id\` - The address for which token authorization is being checked.", {
...
mcpServer.tool("decimals", "Returns the number of decimals used to represent amounts of this token.\n\n# Panics\n\nIf the contract has not yet been initialized.", {
    simulate: z.boolean().optional().describe("If true, simulate the transaction instead of submitting it"),
    signAndSubmit: z.boolean().optional().describe("If true, sign and submit the transaction"),
    secretKey: z.string().optional().describe("Secret key in strkey format (S... for secret keys)")
}, async (params) => {
...
mcpServer.tool("name", "Returns the name for this token.\n\n# Panics\n\nIf the contract has not yet been initialized.", {
    simulate: z.boolean().optional().describe("If true, simulate the transaction instead of submitting it"),
    signAndSubmit: z.boolean().optional().describe("If true, sign and submit the transaction"),
    secretKey: z.string().optional().describe("Secret key in strkey format (S... for secret keys)")
}, async (params) => {
...
mcpServer.tool("admin", "Returns the admin of the contract.\n\n# Panics\n\nIf the admin is not set.", {
    simulate: z.boolean().optional().describe("If true, simulate the transaction instead of submitting it"),
    signAndSubmit: z.boolean().optional().describe("If true, sign and submit the transaction"),
    secretKey: z.string().optional().describe("Secret key in strkey format (S... for secret keys)")
}, async (params) => {
...
mcpServer.tool("symbol", "Returns the symbol for this token.\n\n# Panics\n\nIf the contract has not yet been initialized.", {
    simulate: z.boolean().optional().describe("If true, simulate the transaction instead of submitting it"),
    signAndSubmit: z.boolean().optional().describe("If true, sign and submit the transaction"),
    secretKey: z.string().optional().describe("Secret key in strkey format (S... for secret keys)")
}, async (params) => {
